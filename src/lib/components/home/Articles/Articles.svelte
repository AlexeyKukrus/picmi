<script>
    ...
    const products = [
      { id: 1, title: "Picmi White-Choco with Caramel Macchiato", price: 59, image: "/img/choco.png" },
      { id: 2, title: "Picmi Shopper bag", price: 19, image: "/img/bag.png" },
      { id: 3, title: "Picmi Baseball Cap", price: 24, image: "/img/cap.png" },
      { id: 4, title: "Picmi Sweatshirt", price: 39, image: "/img/sweatshirt.png" },
      { id: 5, title: "Extra Product", price: 29, image: "/img/extra.png" }
    ];
